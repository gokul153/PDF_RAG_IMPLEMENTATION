...
from langchain_core.runnables.history import RunnableWithMessageHistory   ### to include chat hostory
...
if api_key:
    ...
    # Split and create embeddings for the documents
       ...
       print("Embedding complected and stored into vector database")
